...
console.log(color(figlet.textSync('Mikasa Bot-Md', {
		font: 'Pagga',
...
console.log(color('😺 WA NUMBER: +6281365681189','silver'))
console.log(color('Hendraa','mediumseagreen'))
    ...
    console.log(color('😺', 'cyan'), color('Mikasa Bot Is Online...', 'pink'))
...
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: 'Welcome Sayang💐'}, type: 1}
]
let buttonMessage = {
...
└┬❖ 「 @${xeonName.split("@")[0]}  」
   ...
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwkwk`, buttonText: {displayText: 'Sayonara Sayangg 🥀'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./XeonMedia/theme/cheems.xlsx'),
mimetype: docs,
